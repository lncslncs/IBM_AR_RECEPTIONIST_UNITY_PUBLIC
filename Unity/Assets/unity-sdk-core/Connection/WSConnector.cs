...
#region Private Functions
        ...
        {
#if ENABLE_MESSAGE_DEBUGGING
            Log.Debug("WSConnector.ProcessReceiveQueue()", "ConnectionState is: " + _connectionState);
#endif
            ...
            //Log.Debug("WSConnector.ProcessReceiveQueue()", "There are: " + _receiveQueue.Count + " Messages in the receiveQueue");
                ...
                {
#if ENABLE_MESSAGE_DEBUGGING
            Log.Debug("WSConnector.ProcessReceiveQueue()", "We have recieved a message");
#endif
...
#region Threaded Functions
        ...
        private void WebSocket_Closed(IWebSocket sender, WebSocketClosedEventArgs args)
        {
            ...
            Debug.Log("WSConnector:WebSocket_Closed Method: Web Socket Closed");
        }
